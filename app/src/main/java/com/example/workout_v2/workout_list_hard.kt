...
class workout_list_hard : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_workout_list_hard)
        val ambil = intent
        findViewById<ImageView>(R.id.back_workoutlist_hard).setOnClickListener {
            back(ambil)
        }
    }
